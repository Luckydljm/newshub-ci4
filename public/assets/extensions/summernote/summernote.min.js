      ...
      (() => {
                    ...
                    if (a[s]) {
                      ...
                      switch (a[s].action) {
                        ...
                        case Rt.resultAction.SubtractSpanCount:
                          u &&
                            (d > 2 ? (d--, l.setAttribute('rowSpan', d), c.rowIndex !== r && l.cellIndex === i && (l.innerHTML = '')) : 2 === d && (l.removeAttribute('rowSpan'), c.rowIndex !== r && l.cellIndex === i && (l.innerHTML = '')));
                          continue;
        ...
        var Ft = (function () {
          function t(n) {
            ...
            for (
              var i = ['bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'formatBlock', 'removeFormat', 'backColor'], r = 0, a = i.length;
              r < a;
              r++
            )
              (this[i[r]] = (function (t) {
                ...
                value: function () {
                  ...
                  this.context.memo('button.bold', function () {
                    ...
                    this.context.memo('button.ol', function () {
                      return t
                        .button({ contents: t.ui.icon(t.options.icons.orderedlist), tooltip: t.lang.lists.ordered + t.representShortcut('insertOrderedList'), click: t.context.createInvokeHandler('editor.insertOrderedList') })
                        .render();
                    });
                  ...
                  this.context.memo('button.justifyLeft', v.invoke(r, 'render')),
                    ...
                    this.context.memo('button.fullscreen', function () {
                      return t
                        .button({ className: 'btn-fullscreen note-codeview-keep', contents: t.ui.icon(t.options.icons.arrowsAlt), tooltip: t.lang.options.fullscreen, click: t.context.createInvokeHandler('fullscreen.toggle') })
                        .render();
                    }),
              ...
              },
              {
                ...
                value: function (t) {
                  this.$popover.is(':visible') &&
                    (t.keyCode === wt.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === wt.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === wt.code.DOWN && (t.preventDefault(), this.moveDown()));
                },
              },
              {
                key: 'searchKeyword',
