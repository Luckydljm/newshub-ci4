...
$routes->get('/manage_user', 'Register::index'); 
$routes->post('/manage_user/save', 'Register::save'); 
$routes->post('/manage_user/delete', 'Register::delete'); 
$routes->post('/manage_user/edit', 'Register::edit'); 
...
$routes->get('/add_news', 'News::create'); 
$routes->post('/add_news/save', 'News::save');
