                ...
                <div class="logo">
                    <a href="#">
                        <blockquote class="blockquote">
                            <p class="display-6 text-primary-emphasis fw-bold">NEWSHub.</p>
                        </blockquote>
                    </a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item <?php if ($title == 'Kategori') echo 'active'; ?>">
                            <a href="<?= base_url('category'); ?>">Kategori</a>
                        </li>
                        <li class="submenu-item <?php if ($title == 'Daftar Berita') echo 'active'; ?>">
                            <a href="<?= base_url('news'); ?>">Daftar Berita</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a href="<?= base_url('manage_user'); ?>" class="sidebar-link">
